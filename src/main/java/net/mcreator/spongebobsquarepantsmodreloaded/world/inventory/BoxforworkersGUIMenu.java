...
package net.mcreator.spongebobsquarepantsmodreloaded.world.inventory;
...
import net.mcreator.spongebobsquarepantsmodreloaded.init.SpongebobsquarepantsmodreloadedModMenus;

import java.util.function.Supplier;
import java.util.Map;
import java.util.HashMap;

public class BoxforworkersGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BoxforworkersGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SpongebobsquarepantsmodreloadedModMenus.BOXFORWORKERS_GUI, id);
		...
		this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 61, 62) {
		}));
