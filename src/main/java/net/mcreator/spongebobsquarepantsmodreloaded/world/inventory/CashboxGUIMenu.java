...
public class CashboxGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CashboxGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SpongebobsquarepantsmodreloadedModMenus.CASHBOX_GUI, id);
