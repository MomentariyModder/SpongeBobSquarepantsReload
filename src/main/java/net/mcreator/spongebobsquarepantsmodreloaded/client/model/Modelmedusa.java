...
public class Modelmedusa<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("spongebobsquarepantsmodreloaded", "modelmedusa"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 26).addBox(-4.0F, -18.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition bone2 = partdefinition.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(-0.05F)).texOffs(0, 0)
						.addBox(1.0F, 0.0F, 0.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(-0.05F)).texOffs(0, 0)
						.addBox(6.0F, 0.0F, 0.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(-0.05F)).texOffs(0, 0).addBox(4.0F, 0.0F, 0.0F, 1.0F, 4.0F,
								1.0F, new CubeDeformation(-0.05F)),
