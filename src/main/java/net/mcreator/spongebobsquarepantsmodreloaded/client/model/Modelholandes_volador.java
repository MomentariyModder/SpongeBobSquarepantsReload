...
public class Modelholandes_volador<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("spongebobsquarepantsmodreloaded", "modelholandes_volador"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -14.5F, -3.0F, 8.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 10.0F, 0.0F));
		PartDefinition bone_r1 = bone.addOrReplaceChild("bone_r1",
				CubeListBuilder.create().texOffs(48, 15).addBox(-2.0F, 7.1F, 6.7F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.6F)),
				PartPose.offsetAndRotation(0.0F, -0.1F, 0.0F, -1.5446F, 0.0F, 0.0F));
		PartDefinition bone_r2 = bone.addOrReplaceChild("bone_r2",
				CubeListBuilder.create().texOffs(48, 15).addBox(-2.0F, 6.0F, 1.8F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.1F, 0.0F, -1.0908F, 0.0F, 0.0F));
		PartDefinition bone_r3 = bone.addOrReplaceChild("bone_r3",
				CubeListBuilder.create().texOffs(42, 0).addBox(-3.0F, -2.0F, -2.8F, 6.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.1F, 0.0F, -0.5672F, 0.0F, 0.0F));
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 21).addBox(-5.0F, -10.0F, -5.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 56)
		...
		PartDefinition head_r1 = head.addOrReplaceChild("head_r1",
				CubeListBuilder.create().texOffs(37, 18).addBox(4.0F, -1.0F, -5.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.2F)),
				PartPose.offsetAndRotation(-4.5F, -2.0F, -5.0F, -0.3142F, 0.0F, 0.0F));
		PartDefinition rightLeg = partdefinition.addOrReplaceChild("rightLeg", CubeListBuilder.create(), PartPose.offset(4.0F, -4.0F, 0.0F));
		PartDefinition rightLeg_r1 = rightLeg.addOrReplaceChild("rightLeg_r1",
				CubeListBuilder.create().texOffs(28, 0).addBox(0.0F, 8.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(-0.1F)),
		...
		PartDefinition rightLeg_r2 = rightLeg.addOrReplaceChild("rightLeg_r2",
				CubeListBuilder.create().texOffs(28, 0).addBox(0.0F, 0.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1309F, 0.0F, -0.0436F));
		PartDefinition leftLeg = partdefinition.addOrReplaceChild("leftLeg", CubeListBuilder.create(), PartPose.offset(-4.0F, -4.0F, 0.0F));
