...
public class FridgeGUIScreen extends AbstractContainerScreen<FridgeGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("spongebobsquarepantsmodreloaded:textures/fridge_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Fridge", 6, 7, -13421773);
	}
