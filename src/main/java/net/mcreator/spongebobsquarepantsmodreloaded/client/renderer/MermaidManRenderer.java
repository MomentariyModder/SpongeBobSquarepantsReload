...
public class MermaidManRenderer extends HumanoidMobRenderer<MermaidManEntity, HumanoidModel<MermaidManEntity>> {
	public MermaidManRenderer(EntityRendererProvider.Context context) {
