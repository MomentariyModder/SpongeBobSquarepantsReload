...
public class BarnacleBoyRenderer extends HumanoidMobRenderer<BarnacleBoyEntity, HumanoidModel<BarnacleBoyEntity>> {
	public BarnacleBoyRenderer(EntityRendererProvider.Context context) {
