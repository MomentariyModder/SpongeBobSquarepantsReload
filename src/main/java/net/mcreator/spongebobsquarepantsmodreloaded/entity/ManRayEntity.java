...
public class ManRayEntity extends Monster {
	public ManRayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SpongebobsquarepantsmodreloadedModEntities.MAN_RAY.get(), world);
	}

	public ManRayEntity(EntityType<ManRayEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
