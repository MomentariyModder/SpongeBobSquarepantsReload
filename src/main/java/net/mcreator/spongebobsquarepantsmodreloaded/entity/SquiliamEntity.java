...
public class SquiliamEntity extends PathfinderMob {
	public SquiliamEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SpongebobsquarepantsmodreloadedModEntities.SQUILIAM.get(), world);
	}

	public SquiliamEntity(EntityType<SquiliamEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
