...
public class Modelplankton<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "plankton"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -24.0F, -4.0F, 8.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, 0)
		...
		PartDefinition bone_r1 = bone.addOrReplaceChild("bone_r1",
				CubeListBuilder.create().texOffs(32, 0)
						.addBox(-3.0F, -37.0F, 12.5F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 0)
		...
		PartDefinition rightArm_r1 = rightArm
				.addOrReplaceChild("rightArm_r1",
						CubeListBuilder.create().texOffs(36, 0).addBox(0.0F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F,
		...
		PartDefinition leftArm_r1 = leftArm
				.addOrReplaceChild("leftArm_r1",
						CubeListBuilder.create().texOffs(36, 0).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition leftLeg = partdefinition.addOrReplaceChild("leftLeg", CubeListBuilder.create().texOffs(32, 11)
				.addBox(-3.0F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 16.0F, 0.0F));

		PartDefinition leftLeg2 = partdefinition.addOrReplaceChild("leftLeg2", CubeListBuilder.create().texOffs(32, 11)
				.addBox(2.0F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 16.0F, 0.0F));
